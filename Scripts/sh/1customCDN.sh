...
# 获取有效 config.sh 链接
get_valid_config() {
    config_list=(https://raw.githubusercontents.com/okyyds/onekey/main/Conf/Qinglong/config.sample.sh https://raw.sevencdn.com/okyyds/onekey/main/Conf/Qinglong/config.sample.sh https://git.metauniverse-cn.com/https://raw.githubusercontent.com/okyyds/onekey/main/Conf/Qinglong/config.sample.sh)
...
# 获取有效 extra.sh 链接
get_valid_extra() {
    extra_list=(https://raw.githubusercontents.com/okyyds/onekey/main/Tasks/qlrepo/extra.sh https://raw.sevencdn.com/okyyds/onekey/main/Tasks/qlrepo/extra.sh https://git.metauniverse-cn.com/https://raw.githubusercontent.com/okyyds/onekey/main/Tasks/qlrepo/extra.sh)
...
# extra.sh 设置区设置
set_default_extra() {   
    echo -e "一、集成仓库 okyyds-yydspure"
    read -p "直接回车拉取yydspure仓库，输入2回车拉取yydspure纯净仓库" CollectedRepo
...
# 获取有效 code.sh 链接
get_valid_code() {
    code_list=(https://raw.githubusercontents.com/okyyds/onekey/main/Scripts/sh/Helpcode2.8/code.sh https://raw.sevencdn.com/okyyds/onekey/main/Scripts/sh/Helpcode2.8/code.sh https://git.metauniverse-cn.com/https://raw.githubusercontents.com/okyyds/onekey/main/Scripts/sh/Helpcode2.8/code.sh)
...
get_valid_task_before() {
    task_before_list=(https://raw.githubusercontents.com/okyyds/onekey/main/Scripts/sh/Helpcode2.8/task_before.sh https://raw.sevencdn.com/okyyds/onekey/main/Scripts/sh/Helpcode2.8/task_before.sh https://git.metauniverse-cn.com/https://raw.githubusercontents.com/okyyds/onekey/main/Scripts/sh/Helpcode2.8/task_before.sh)
